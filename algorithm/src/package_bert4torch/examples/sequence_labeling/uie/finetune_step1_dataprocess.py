...
preprocess(r"D:\Projects\machaoyangNLP\algorithm\src\package_bert4torch\data\china-people-daily-ner-corpus/example.train", './data/mid_data', "train")
preprocess(r"D:\Projects\machaoyangNLP\algorithm\src\package_bert4torch\data\china-people-daily-ner-corpus/example.dev", './data/mid_data', "dev")
preprocess(r"D:\Projects\machaoyangNLP\algorithm\src\package_bert4torch\data\china-people-daily-ner-corpus/example.test", './data/mid_data', "test")